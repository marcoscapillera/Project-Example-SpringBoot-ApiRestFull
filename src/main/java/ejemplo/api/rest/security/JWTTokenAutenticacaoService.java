package ejemplo.api.rest.security;
...
import ejemplo.api.rest.ApplicationContextLoad;
...
public class JWTTokenAutenticacaoService {
	...
	public Authentication getAuhentication(HttpServletRequest request, HttpServletResponse response) {
		...
		/*LIberando la respuesa para una puerta diferente proyecto Angular*/
		freeCorse(response);
	...
	private void freeCorse(HttpServletResponse response) {
